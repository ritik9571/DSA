...
public:
    cir_queue()
    {
        ...
        while (n == 0)
        {
            cout << endl
                 << endl
                 << "\t\t\t\t\tTHE SIZE OF QUEUE CANNOT BE ZERO" << endl;
            cout << endl
                 << endl
...
void cir_queue::search_ele()
{
    ...
    while (temp--)
    {
        ...
        {
            cout << endl
                 << "\t\t\t\t\t!!!! Given element is present in the queue" << endl;
            return;
        }
        i = (i + 1) % n;
    }
    ...
    cout << endl
         << "\t\t\t\t\t!!! Given element is not present in the queue" << endl;
}
...
void cir_queue ::dequeue()
{
    if (c == 0)
    {
        cout << "\t\t\t\t\tQueue is empty You cannot delete element from queue " << endl
             << endl;
        front_q = rear = 0;
    }
    else
    {
        cout << "\t\t\t\t\tElement " << q[front_q] << " is deleted " << endl
             << endl;
        c--;
        if (rear == n + 1)
            rear = (rear - 1) % n;
...
void cir_queue ::display()
{
    cout << endl
         << endl
         << "\t\t\t\t\tElements of queue are as follows : " << endl
         << endl;
    int i = front_q;
    int j = c;
    cout << "\t\t\t\t\t";
...
void my_queue ::sort_q()
{
    ...
    cout << endl
         << "\t\t\t\t\tQUEUE SORTED SUCCESSFULLY" << endl;
}
...
void simple_queue()
{
    ...
    while (ch != 6)
    {
        ...
        cout << endl
             << "\t\t\t\t\tWHAT DO YOU WANT TO DO WITH QUEUE?" << endl;
        cout << "\n\t\t\t\t\t1.Insertion\n\t\t\t\t\t2.deletion\n\t\t\t\t\t3.show\n\t\t\t\t\t4.search\n\t\t\t\t\t5.sort\n\t\t\t\t\t6.exit" << endl
             << endl;
        ...
        case 6:
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! THANK YOU FOR VISITING QUEUE " << endl;
            break;
            break;
        default:
            cout << endl
...
void cir_queue_1()
{
    ...
    while (ch != 6)
    {
        ...
        cout << endl
             << endl
             << "\t\t\t\t\tWHAT DO YOU WANT TO DO WITH CIRCULAR QUEUE?" << endl;
        cout << "\n\t\t\t\t\t1.Insertion\n\t\t\t\t\t2.deletion\n\t\t\t\t\t3.show\n\t\t\t\t\t4.search\n\t\t\t\t\t5.sort\n\t\t\t\t\t6.exit" << endl
             << endl;
        cout << "\t\t\t\t\tEnter your choice : ";
        cin >> ch;
        ...
        case 6:
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! THANK YOU FOR VISITING CIRCULAR QUEUE " << endl;
            break;
            break;
        default:
            cout << endl
                 << "\t\t\t\t\tWRONG CHOICE ENETERED" << endl;
        }
        getchar();
...
public:
    ...
    my_stack()
    {
        ...
        while (siz == 0)
        {
            cout << endl
                 << endl
                 << "\t\t\t\t\tTHE SIZE OF STACK CANNOT BE ZERO" << endl;
            cout << endl
                 << endl
                 << "\t\t\t\t\tPRESS ANY KEY TO CONTINUE ";
            getchar();
...
void my_stack_1()
{
    ...
    while (ch != 8)
    {
        system("cls");
        cout << endl
             << "\t\t\t\t\t******* WELCOME TO STACK DATA STRUCTURE ********** " << endl
             << endl;
        ...
        case 8:
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! THANK YOU FOR VISITING STACK " << endl;
            break;
            break;
        case 4:
            cout << endl
                 << "\t\t\t\t\tThe current size of stack is : " << st.top + 1 << endl;
            break;
        case 5:
            eva_stack();
            break;
...
void traverse(struct node *head)
{
    ...
    if (head->next == NULL)
    {
        ...
        cout << endl
             << "\t\t\t\t\tlast second node does not exist" << endl;
        return;
    }
    struct node *p;
    // p = new node();
...
void delete_at_pos(struct node **head, int x)
{
    ...
    {
        cout << endl
             << "\t\t\t\t\tPosition does not exist in list" << endl;
        return;
    }
...
void singly_list()
{
    ...
    while (x != 10)
    {
        ...
        case 10:
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! THANK YOU FOR VISITING LINKED LIST " << endl;
            break;
            break;
        default:
            cout << endl
    ...
    while (x != 9)
    {
        ...
        case 8:
            ...
            if (x == 1)
                ...
                insert_at_pos(&head, x);
            break;
        case 9:
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! THANK YOU FOR VISITING CIRCULAR LINKED LIST " << endl;
            break;
            break;
        default:
            cout << endl
...
void doubly_list()
{
    ...
    while (x != 8)
    {
        system("cls");
        cout << endl
             << "\t\t\t\t******* WELCOME TO DOUBLY LINKED LIST ********" << endl
             << endl;
        cout << endl
             << "\t\t\t\t\tWHAT DO YOU WANT TO DO?" << endl
             << endl;
        ...
        case 7:
            ...
            if (x == 1)
                ...
                dll_insert_at_pos(&head, x);
            break;
        case 8:
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! THANK YOU FOR VISITING DOUBLY LINKED LIST " << endl;
            break;
            break;
        default:
            cout << endl
...
void cir_doubly_list()
{
    ...
    while (x != 8)
    {
        system("cls");
        cout << endl
             << "\t\t\t\t******* WELCOME TO CIRCULAR DOUBLY LINKED LIST ********" << endl
             << endl;
        cout << endl
             << "\t\t\t\t\tWHAT DO YOU WANT TO DO?" << endl
             << endl;
        ...
        case 8:
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! THANK YOU FOR VISITING CIRCULAR DOUBLY LINKED LIST " << endl;
            break;
            break;
        }
        getchar();
...
void bst_max(struct tree *root)
{
    ...
    cout << endl
         << "\t\t\t\t\tThe max element is : " << q->data << endl;
}
...
void bst_min(struct tree *root)
{
    ...
    cout << endl
         << "\t\t\t\t\tThe min element is : " << q->data << endl;
}
...
void bst()
{
    ...
    while (ch != 8)
    {
        ...
        cout << endl
             << endl
             << "\t\t\t\t******* WELCOME TO BINARY SEARCH TREE ******** " << endl
             << endl;
        ...
        case 8:
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! THANK YOU FOR VISITING BINARY SEARCH TREE " << endl;
            break;
            break;
        default:
            cout << endl
...
void no_of_nodes(struct tree *root)
{
    ...
    {
        cout << endl
             << "\t\t\t\t\tThe number of node in tree are : 0" << endl;
        return;
    }
    ...
    cout << endl
         << "\t\t\t\t\tThe number of nodes in tree are : " << no_nodes << endl;
}
...
void binary_tree()
{
    ...
    while (ch != 10)
    {
        ...
        cout << endl
             ...
             << endl;
        cout << "\t\t\t\t\t*NOTE : THE HEIGHT OF ROOT IS 1" << endl
             << endl;
        cout << "\t\t\t\t\tWHAT DO YOU WANT TO DO?" << endl
             << endl;
        ...
        case 9:
            ...
            {
                mirror(root, &m);
                cout << "\t\t\t\tPreorder traversal of original tree : ";
                preorder(root);
                cout << endl
        ...
        case 10:
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! THANK YOU FOR VISITING BINARY TREE " << endl;
            break;
            break;
        default:
            cout << endl
    ...
    while (ch != 4)
    {
        ...
        case 2:
            ...
            else
            {
                ...
                cout << endl
                     << "\t\t\t\t\tElement " << s2.top() << " is deleted " << endl;
                s2.pop();
        ...
        case 4:
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! THANK YOU FOR VISITING QUEUE USING STACK " << endl;
            break;
            break;
        default:
            cout << endl
...
void stack_using_queue()
{
    ...
    while (ch != 4)
    {
        ...
        cout << endl
             << "\t\t\t\t\tWHAT DO YOU WANT TO DO WITH STACK?" << endl;
        cout << "\n\t\t\t\t\t1.Push\n\t\t\t\t\t2.Pop\n\t\t\t\t\t3.show\n\t\t\t\t\t4.exit" << endl
             << endl;
        cout << "\t\t\t\t\tEnter your choice : ";
        cin >> ch;
        ...
        case 2:
            ...
            {
                cout << endl
                     << "\t\t\t\t\tElement : " << q1.front() << " is deleted " << endl;
                q1.pop();
            }
            break;
        ...
        case 3:
            cout << endl
                 << "\t\t\t\t\tThe element of stack are as follows : " << endl;
            cout << "\t\t\t\t\t";
            while (q1.empty() == false)
            {
                cout << q1.front() << endl;
        ...
        case 4:
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! THANK YOU FOR VISITING STACK USING QUEUE " << endl;
            break;
            break;
        default:
            cout << endl
...
void my_deque()
{
    ...
    while (ch != 6)
    {
        ...
        case 6:
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! THANK YOU FOR VISITING DEQUE " << endl;
            break;
            break;
        default:
            cout << endl
...
void sorting(int arr[], int n)
{
    ...
    while (ch1 != 6)
    {
        ...
        cout << endl
             << endl
             << endl
             << "\t\t\t\t\t**** WHAT TYPE OF SORTING DO YOU WANT TO DO? ****" << endl;
        cout << endl
             << "\t\t\t\t\t1.Selection_sort\n\t\t\t\t\t2.Bubble_sort\n\t\t\t\t\t3.Insertion_sort\n\t\t\t\t\t4.Merge_sort\n\t\t\t\t\t5.Quick_sort\n\t\t\t\t\t6.Exit\n\n";
        cout << "\t\t\t\t\tEnter Your Choice : ";
        cin >> ch1;
...
int deletion(int arr[], int n)
{
    ...
    if (found == false)
    {
        cout << endl
             << endl
             << "\t\t\t\t!!! SORRY GIVEN ELEMENT IS NOT PRESENT IN ARRAY" << endl;
        return n;
    }
    else
    {
...
void linear_search(int arr[], int n)
{
    ...
    for (int i = 0; i < n; i++)
    {
        if (arr[i] == ele)
        {
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! HURRAH !!! THE GIVEN ELEMENT IS PRESENT IN ARRAY AT POSITION : " << i + 1 << endl;
            return;
        }
    }
    cout << endl
         << endl
         << "\t\t\t\t\t!!!! OOPS THE GIVEN ELEMENT IS NOT PRESENT IN ARRAY" << endl;
}
...
void binary_search(int arr[], int n)
{
    ...
    while (l <= r)
    {
        ...
        if (temp[mid] == ele)
        {
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! HURRAH !!! THE GIVEN ELEMENT IS PRESENT IN ARRAY " << endl;
            return;
        }
        if (ele < temp[mid])
            r = mid - 1;
...
void arr()
{
    ...
    while (cap == 0)
    {
        cout << endl
             << endl
             << "\t\t\t\t\tTHE CAPACITY OF ARRAY CANNOT BE 0";
        cout << endl
             << endl
             << "\t\t\t\t\tPRESS ANY KEY TO CONTINUE";
        getchar();
    ...
    while (ch != 6)
    {
        system("cls");
        cout << endl
             << "\t\t\t\t**** WELCOME TO ARRAY DATA STRUCTURE *******" << endl
             << endl;
        cout << "\t\t\t\t\t**** WHAT DO YOU WANT TO DO? *******" << endl
             << endl;
        cout << "\t\t\t\t\t1.Insertion\n\t\t\t\t\t2.Deletion\n\t\t\t\t\t3.Sorting\n\t\t\t\t\t4.Searching\n\t\t\t\t\t5.Show\n\t\t\t\t\t6.Exit" << endl
        ...
        case 6:
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! THANK YOU FOR VISITING ARRAY " << endl;
            break;
            break;
        default:
            cout << endl
...
void avl_tree()
{
    ...
    while (ch != 6)
    {
        ...
        case 5:
                 ...
                 << "\t\t\t\t\tEnter the element to delete : ";
            {
                ...
                if (!avl_search(root, x))
                    cout << endl
                         << endl
                         << "\t\t\t\t\t!!! OOPS EITHER THE GIVEN ELEMENT IS NOT PRESENT IN TREE OR TREE IS EMPTY " << endl;
                else
                {
        ...
        case 6:
            cout << endl
                 << endl
                 << "\t\t\t\t\t!!! THANK YOU FOR VISITING AVL TREE " << endl;
            break;
        default:
            cout << endl
                 << "\t\t\t\t\tWRONG CHOICE ENTERED" << endl;
...
int main()
{
    ...
    while (ch != 15)
    {
        ...
        case 15:
            cout << endl
                 << endl
                 << "\t\t\t\t!!!!!! THANK YOU FOR USING ALL IN ONE DATA STRUCTURE !!!!!!!";
            getchar();
            cout << endl
                 << endl
                 << "\t\t\t\tPRESS ANY KEY TO CONTINUE";
